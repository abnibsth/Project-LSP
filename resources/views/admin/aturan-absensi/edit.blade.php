                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="time" name="jam_masuk"
                            ...
                            class="form-input @error('jam_masuk') border-red-400 @enderror">
                        @error('jam_masuk')
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_keluar"
                            ...
                            class="form-input @error('jam_keluar') border-red-400 @enderror">
                        @error('jam_keluar')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg shadow-sm">
                            <input type="number" name="toleransi_menit" min="0" max="120"
                                ...
                                class="flex-1 min-w-0 block w-full border border-hairline rounded-none rounded-l-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary @error('toleransi_menit') border-red-400 @enderror">
                            <span class="inline-flex items-center px-3 rounded-r-lg border border-l-0 border-hairline bg-canvas-parchment text-ink-muted-48 text-sm">
                                menit
                            </span>
                        </div>
            ...
            <div class="bg-white rounded-xl border border-hairline shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="flex rounded-lg shadow-sm">
                            <span class="inline-flex items-center px-3 rounded-l-lg border border-r-0 border-hairline bg-canvas-parchment text-ink-muted-48 text-sm">
                                Rp
                            </span>
                            <input type="number" name="potongan_per_alpha" min="0" step="1000"
                                value="{{ (int) old('potongan_per_alpha', $rule->potongan_per_alpha) }}"
                                class="flex-1 min-w-0 block w-full border border-hairline rounded-none rounded-r-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary @error('potongan_per_alpha') border-red-400 @enderror">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg shadow-sm">
                            ...
                            <input type="number" name="potongan_per_menit_telat" min="0" step="100"
                                ...
                                class="flex-1 min-w-0 block w-full border border-hairline rounded-none rounded-r-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary @error('potongan_per_menit_telat') border-red-400 @enderror">
                        </div>
